...
const p = 559784823609444184073982810118574696524917881053819639836546641442408838587276888219167938595222810044252210024146426427; // big prime number
const g = 429; // generator number

const a = 546; // big random number
const b = 358; // big random number
